...
assert.match(engine, /probeKaizenProxyDestination\(proxy, \{ host: 'accounts\.google\.com', port: 443 \}\)/, 'Google auth destination must be preflighted through the assigned proxy');
