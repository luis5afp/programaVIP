...
assert.equal(versionAtLeast('0.3.40', MIN_SESSION_MANAGER_VERSION), true);
...
assert.equal(sessionPackage.version, '0.3.40');
assert.equal(MIN_USERFLOW_VERSION, '0.3.36');
assert.equal(MIN_SESSION_MANAGER_VERSION, '0.3.40');
