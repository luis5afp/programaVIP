...
assert.equal(compareVersions('0.3.16', '0.3.16'), 0);
assert.equal(compareVersions('0.3.17', '0.3.16'), 1);
assert.equal(compareVersions('0.4.0', '0.3.99'), 1);
assert.equal(compareVersions('1.0.0', '0.99.99'), 1);
assert.equal(compareVersions('0.3.15', '0.3.16'), -1);
assert.equal(compareVersions('bad', '0.3.16'), null);
assert.equal(versionAtLeast('0.3.16', MIN_USERFLOW_VERSION), true);
assert.equal(versionAtLeast('0.3.15', MIN_USERFLOW_VERSION), false);
