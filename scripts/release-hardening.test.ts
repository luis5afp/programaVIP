...
assert.equal(compareVersions('0.3.27', '0.3.26'), 1);
...
assert.equal(versionAtLeast('0.3.26', MIN_USERFLOW_VERSION), true);
assert.equal(versionAtLeast('0.3.25', MIN_USERFLOW_VERSION), false);
