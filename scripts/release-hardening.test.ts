...
assert.equal(compareVersions('0.3.24', '0.3.25'), -1);
assert.equal(compareVersions('bad', '0.3.22'), null);
assert.equal(versionAtLeast('0.3.25', MIN_USERFLOW_VERSION), true);
assert.equal(versionAtLeast('0.3.24', MIN_USERFLOW_VERSION), false);
