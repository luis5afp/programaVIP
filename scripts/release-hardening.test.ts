...
assert.equal(compareVersions('0.3.40', '0.3.40'), 0);
assert.equal(compareVersions('0.3.40', '0.3.37'), 1);
assert.equal(compareVersions('0.3.37', '0.3.40'), -1);
assert.equal(compareVersions('0.4.0', '0.3.99'), 1);
assert.equal(compareVersions('1.0.0', '0.99.99'), 1);
assert.equal(compareVersions('bad', '0.3.22'), null);

assert.equal(versionAtLeast('0.3.40', MIN_USERFLOW_VERSION), true);
assert.equal(versionAtLeast('0.3.39', MIN_USERFLOW_VERSION), false);
assert.equal(versionAtLeast('0.3.44', MIN_SESSION_MANAGER_VERSION), true);
assert.equal(versionAtLeast('0.3.43', MIN_SESSION_MANAGER_VERSION), false);
...
assert.equal(clientPackage.version, '0.3.40');
assert.equal(sessionPackage.version, '0.3.44');
assert.equal(MIN_USERFLOW_VERSION, '0.3.40');
assert.equal(MIN_SESSION_MANAGER_VERSION, '0.3.44');
