...
assert.equal(compareVersions('0.3.19', '0.3.19'), 0);
assert.equal(compareVersions('0.3.20', '0.3.19'), 1);
assert.equal(compareVersions('0.4.0', '0.3.99'), 1);
assert.equal(compareVersions('1.0.0', '0.99.99'), 1);
assert.equal(compareVersions('0.3.18', '0.3.19'), -1);
assert.equal(compareVersions('bad', '0.3.19'), null);
assert.equal(versionAtLeast('0.3.19', MIN_USERFLOW_VERSION), true);
assert.equal(versionAtLeast('0.3.18', MIN_USERFLOW_VERSION), false);
