...
assert.equal(compareVersions('0.3.35', '0.3.35'), 0);
assert.equal(compareVersions('0.3.36', '0.3.35'), 1);
assert.equal(compareVersions('0.4.0', '0.3.99'), 1);
assert.equal(compareVersions('1.0.0', '0.99.99'), 1);
assert.equal(compareVersions('0.3.34', '0.3.35'), -1);
assert.equal(compareVersions('bad', '0.3.22'), null);
assert.equal(versionAtLeast('0.3.35', MIN_USERFLOW_VERSION), true);
assert.equal(versionAtLeast('0.3.34', MIN_USERFLOW_VERSION), false);
