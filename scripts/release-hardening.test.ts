...
assert.equal(compareVersions('bad', '0.3.6'), null);
assert.equal(versionAtLeast('0.3.6', MIN_USERFLOW_VERSION), true);
assert.equal(versionAtLeast('0.3.5', MIN_USERFLOW_VERSION), false);
