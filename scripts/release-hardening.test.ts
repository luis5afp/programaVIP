...
assert.equal(compareVersions('0.3.8', '0.3.8'), 0);
assert.equal(compareVersions('0.3.9', '0.3.8'), 1);
assert.equal(compareVersions('0.4.0', '0.3.99'), 1);
assert.equal(compareVersions('1.0.0', '0.99.99'), 1);
assert.equal(compareVersions('0.3.7', '0.3.8'), -1);
assert.equal(compareVersions('bad', '0.3.8'), null);
assert.equal(versionAtLeast('0.3.8', MIN_USERFLOW_VERSION), true);
assert.equal(versionAtLeast('0.3.7', MIN_USERFLOW_VERSION), false);
