...
assert.equal(compareVersions('bad', '0.3.12'), null);
assert.equal(versionAtLeast('0.3.12', MIN_USERFLOW_VERSION), true);
assert.equal(versionAtLeast('0.3.11', MIN_USERFLOW_VERSION), false);
