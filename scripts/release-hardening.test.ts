...
assert.equal(versionAtLeast('0.3.45', MIN_SESSION_MANAGER_VERSION), true);
...
assert.equal(sessionPackage.version, '0.3.45');
assert.equal(MIN_USERFLOW_VERSION, '0.3.41');
assert.equal(MIN_SESSION_MANAGER_VERSION, '0.3.45');
